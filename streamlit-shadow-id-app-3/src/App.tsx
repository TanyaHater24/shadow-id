...
const REQUIREMENTS = `streamlit==1.45.0
openai==1.30.1
httpx==0.27.0`;

const CONFIG_TOML = `[theme]
primaryColor = "#a855f7"
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1.1rem' }}>
            Создай 3 файла на GitHub — и готово!
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ color: '#00ffff', margin: '0 0 16px 0', fontSize: '1.3rem' }}>
            📋 ИНСТРУКЦИЯ
          </h2>
          <ol style={{ margin: 0, paddingLeft: '20px', lineHeight: '2' }}>
            <li><strong>Удали</strong> старый репозиторий <code>shadow-id</code> на GitHub (Settings → Delete)</li>
            <li><strong>Создай</strong> новый: <code>+</code> → <code>New repository</code> → имя <code>shadow-id</code> → <strong>Public</strong></li>
            <li><strong>Создай 3 файла</strong> прямо на GitHub (кнопки ниже — копируй код)</li>
            <li><strong>Деплой:</strong> <a href="https://share.streamlit.io" target="_blank" style={{color: '#ff00ff'}}>share.streamlit.io</a> → New app → Выбери репо → Deploy!</li>
          </ol>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <h3 style={{ color: '#ff00ff', margin: 0 }}>📄 Файл 1: app.py</h3>
            <button
              onClick={() => copyToClipboard(APP_PY, 'app')}
              style={{
                background: copied === 'app' ? '#00ff00' : 'linear-gradient(135deg, #8b00ff, #ff00ff)',
                color: 'white',
                border: 'none',
                padding: '10px 20px',
                borderRadius: '8px',
            ...
            >
              {copied === 'app' ? '✓ Скопировано!' : '📋 Копировать код'}
            </button>
          </div>
          <p style={{ color: 'rgba(255,255,255,0.7)', margin: 0, fontSize: '0.9rem' }}>
            На GitHub: <strong>Add file</strong> → <strong>Create new file</strong> → имя: <code>app.py</code> → вставь код → <strong>Commit</strong>
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <h3 style={{ color: '#00ffff', margin: 0 }}>📄 Файл 2: requirements.txt</h3>
            <button
              onClick={() => copyToClipboard(REQUIREMENTS, 'req')}
              style={{
                background: copied === 'req' ? '#00ff00' : 'linear-gradient(135deg, #00a0a0, #00ffff)',
                color: 'white',
                border: 'none',
                padding: '10px 20px',
                borderRadius: '8px',
            ...
            >
              {copied === 'req' ? '✓ Скопировано!' : '📋 Копировать код'}
            </button>
          </div>
          <pre style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <h3 style={{ color: '#90EE90', margin: 0 }}>📄 Файл 3: .streamlit/config.toml</h3>
            <button
              onClick={() => copyToClipboard(CONFIG_TOML, 'config')}
              style={{
                background: copied === 'config' ? '#00ff00' : 'linear-gradient(135deg, #228B22, #90EE90)',
                color: 'white',
                border: 'none',
                padding: '10px 20px',
                borderRadius: '8px',
            ...
            >
              {copied === 'config' ? '✓ Скопировано!' : '📋 Копировать код'}
            </button>
          </div>
          <p style={{ color: 'rgba(255,255,255,0.7)', margin: '0 0 12px 0', fontSize: '0.9rem' }}>
            ⚠️ Имя файла: <code>.streamlit/config.toml</code> — GitHub сам создаст папку!
          </p>
          <pre style={{
            background: 'rgba(0,0,0,0.3)',
            padding: '12px',
        ...
        <div style={{
          ...
          <p style={{ margin: 0, color: 'rgba(255,255,255,0.8)' }}>
            🎉 После деплоя получишь ссылку типа:<br/>
            <code style={{ color: '#00ffff', fontSize: '1.1rem' }}>https://tanyahater24-shadow-id.streamlit.app</code>
          </p>
        </div>
